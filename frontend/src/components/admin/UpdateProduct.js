...
import { updateProduct, getProductDeatails, clearErrors } from '../../actions/productActions'
...
const UpdateProduct = ({ match, history }) => {
    ...
    useEffect(() => {
        ...
        if (product && product._id !== productId) {
            dispatch(getProductDeatails(productId));
        } else {
                        ...
                        <div className="wrapper my-5">
                            <form className="shadow-lg" onSubmit={submitHandler} encType="multipart/form-data">
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="number" id="stock_field" className="form-control" value={stock}
                                        onChange={(e) => setStock(e.target.value)} />
                                </div>
                                <div className="form-group">
                                    <label htmlFor="seller_field">Seller Name</label>
                                    <input type="text" id="seller_field" className="form-control" value={seller}
                                        onChange={(e) => setSeller(e.target.value)} />
                                </div>
                                <div className="form-group">
                                    <label>Images</label>
                                    <div className="custom-file">
                                        <input type="file" name="product_images" className="custom-file-input" id="customFile"
                                            onChange={onChange}
                                            multiple />
