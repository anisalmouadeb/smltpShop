...
export const productResources = (state = { products: [] }, action) => {
    ...
    switch (action.type) {
        ...
        case GET_PROMO_SUCCESS : return {
            loading : false,
            products: action.payload.products
        }
        case ADMIN_PRODUCTS_SUCCESS : return {
            loading: false,
...
export const promoReducer = (state = { products: [] }, action) => {
